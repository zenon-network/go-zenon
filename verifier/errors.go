...
var (
	...
	ErrABFromBlockHashMissing      = errors.New("account-block from-block-hash is not provided")
	...
	ErrMTimestampNotIncreasing  = errors.New("momentum timestamp is lower than previous timestamp")
