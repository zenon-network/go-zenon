...
type AccountBlockProto struct {
	...
	MultisigAuth         *MultisigAuthProto     `protobuf:"bytes,24,opt,name=multisigAuth,proto3" json:"multisigAuth,omitempty"`
}
...
func (x *AccountBlockProto) GetMultisigAuth() *MultisigAuthProto {
	if x != nil {
		return x.MultisigAuth
	}
	return nil
}

type MultisigAuthProto struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *MultisigAuthProto) Reset() {
	*x = MultisigAuthProto{}
	if protoimpl.UnsafeEnabled {
...
func (x *MultisigAuthProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MultisigAuthProto) ProtoMessage() {}

func (x *MultisigAuthProto) ProtoReflect() protoreflect.Message {
	mi := &file_chain_nom_protobuf_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MultisigAuthProto.ProtoReflect.Descriptor instead.
func (*MultisigAuthProto) Descriptor() ([]byte, []int) {
	return file_chain_nom_protobuf_proto_rawDescGZIP(), []int{1}
}

func (x *MultisigAuthProto) GetSignatures() [][]byte {
	if x != nil {
		return x.Signatures
	}
	return nil
...
type MomentumProto struct {
	...
	NextFusionPrice uint64                      `protobuf:"varint,12,opt,name=nextFusionPrice,proto3" json:"nextFusionPrice,omitempty"`
	NextWorkPrice   uint64                      `protobuf:"varint,13,opt,name=nextWorkPrice,proto3" json:"nextWorkPrice,omitempty"`
}

func (x *MomentumProto) Reset() {
	*x = MomentumProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chain_nom_protobuf_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MomentumProto) Descriptor() ([]byte, []int) {
	return file_chain_nom_protobuf_proto_rawDescGZIP(), []int{2}
}
...
func (x *MomentumProto) GetNextFusionPrice() uint64 {
	if x != nil {
		return x.NextFusionPrice
	}
	return 0
}

func (x *MomentumProto) GetNextWorkPrice() uint64 {
	if x != nil {
		return x.NextWorkPrice
	}
	return 0
}
...
var file_chain_nom_protobuf_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x07, 0x0a,
	...
	0x0a, 0x0c, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x41, 0x75, 0x74, 0x68, 0x18, 0x18,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6e, 0x6f, 0x6d, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69,
	0x73, 0x69, 0x67, 0x41, 0x75, 0x74, 0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x52, 0x0c, 0x6d, 0x75,
	0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x41, 0x75, 0x74, 0x68, 0x22, 0x33, 0x0a, 0x11, 0x4d, 0x75,
	0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x41, 0x75, 0x74, 0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	,
	...
	,
	...
	,
...
var file_chain_nom_protobuf_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_chain_nom_protobuf_proto_goTypes = []interface{}{
	(*AccountBlockProto)(nil),        // 0: nom.AccountBlockProto
	(*MultisigAuthProto)(nil),        // 1: nom.MultisigAuthProto
	(*MomentumProto)(nil),            // 2: nom.MomentumProto
	(*types.HashProto)(nil),          // 3: types.HashProto
	(*types.HashHeightProto)(nil),    // 4: types.HashHeightProto
	(*types.AddressProto)(nil),       // 5: types.AddressProto
	(*types.AccountHeaderProto)(nil), // 6: types.AccountHeaderProto
}
var file_chain_nom_protobuf_proto_depIdxs = []int32{
	3,  // 0: nom.AccountBlockProto.hash:type_name -> types.HashProto
	3,  // 1: nom.AccountBlockProto.previousHash:type_name -> types.HashProto
	4,  // 2: nom.AccountBlockProto.momentumAcknowledged:type_name -> types.HashHeightProto
	5,  // 3: nom.AccountBlockProto.address:type_name -> types.AddressProto
	5,  // 4: nom.AccountBlockProto.toAddress:type_name -> types.AddressProto
	3,  // 5: nom.AccountBlockProto.fromBlockHash:type_name -> types.HashProto
	0,  // 6: nom.AccountBlockProto.descendantBlocks:type_name -> nom.AccountBlockProto
	3,  // 7: nom.AccountBlockProto.changesHash:type_name -> types.HashProto
	1,  // 8: nom.AccountBlockProto.multisigAuth:type_name -> nom.MultisigAuthProto
	3,  // 9: nom.MomentumProto.hash:type_name -> types.HashProto
	3,  // 10: nom.MomentumProto.previousHash:type_name -> types.HashProto
	6,  // 11: nom.MomentumProto.content:type_name -> types.AccountHeaderProto
	3,  // 12: nom.MomentumProto.changesHash:type_name -> types.HashProto
...
func file_chain_nom_protobuf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chain_nom_protobuf_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MultisigAuthProto); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_nom_protobuf_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
